Prevent Cardholder Self-Reconciliation
======================

This git repository represents the University of Arizona (the UA)'s _Prevent Cardholder Self-Reconciliation_ modification to **KFS 3.0**, in the form of patch files (generated by svn diff), liquibase scripts, and documentation.
...
* [`patches/09201_KITT-909_cleaned.diff`](Prevent-Cardholder-Self-Reconciliation/blob/master/patches/09201_KITT-909_cleaned.diff) is the patch file for #9201.
...
[Here](Prevent-Cardholder-Self-Reconciliation/blob/master/patch_log.txt) is a printout of `svn log -v` for each revision.
